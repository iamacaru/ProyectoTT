 ...
 * @file EKF_GEOS3.cpp
 *
 * @mainpage Initial Orbit Determination
 *
 * @brief Main function demonstrating Initial Orbit Determination using Gauss and Extended Kalman Filter methods.
 *
 * This function reads observational data, initializes parameters, and performs orbit determination using a
 * combination of Gauss method and Extended Kalman Filter. It also calculates and prints the error in position
